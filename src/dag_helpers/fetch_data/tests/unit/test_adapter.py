...
def test_adapter_generate_read_and_write_baseline(tmp_path: Path) -> None:
	...
	pre_path = save_pre_transformation_canonical_baseline_artifact(
		...
		path=tmp_path / "pre_baseline.json",
	)
	...
	baseline_path = save_post_transformation_canonical_baseline_artifact(events=events, path=out_baseline)
...
def test_canonical_baseline_artifacts_identical(tmp_path: Path) -> None:
	...
	post_path = save_post_transformation_canonical_baseline_artifact(
		events=events,
		path=tmp_path / "post_baseline.json",
	)
